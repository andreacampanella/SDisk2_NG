...
avr-gcc -o "oled.o" "oled.c" -Wall -Os -Wno-deprecated-declarations -Wno-strict-aliasing -D__PROG_TYPES_COMPAT__ -fpack-struct -fshort-enums -std=gnu99 -funsigned-char -funsigned-bitfields -mmcu=atmega328p -DF_CPU=25000000UL -MMD -MP -c 
...
avr-gcc -Wl,-Map,sdisk2_oled.map -mmcu=atmega328p -o "sdisk2_oled.elf" "main.o" "oled.o" "SPI_routines.o" "SD_routines.o" "FAT32.o" "sub.o"  
avr-objcopy -R .eeprom -O ihex "sdisk2_oled.elf" "sdisk2_oled.hex"
avr-size --format=avr --mcu=atmega328p "sdisk2_oled.elf"

mv sdisk2_oled.hex ../out/
